...
#define LED_MSC_OFF() ledState = false; clearCoreLEDsend()
#define LED_MSC_ON() ledState = true; clearCoreLEDsend()
#define LED_MSC_TGL() ledState = !ledState; clearCoreLEDsend()
#else
